...
float image_plane = -2.0;           // image plane position
...
int main( int argc, char **argv )
{
	...
	for(int i = 3; i < argc; i++)
	{
		...
		if (strcmp(argv[i], "+f") == 0) stochastic_ray_on = true;
	...
	glutInitWindowPosition(960,500); // Center the game window (well, on a 1920x1080 display)
